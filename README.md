...
**Frontend**
`React` `Angular` `TypeScript` `Tailwind CSS` `Gradio`

**Tools**
`Git` `Docker` `Jupyter` `Vercel` `Google Colab`

---

## 🚀 Featured Projects

### 🔬 PDIS — Pharma Document Intelligence System
...
### ♟️ chess-ai-arena
> Classical AI research project, extended into a full benchmark suite

From-scratch Python chess engine — every algorithm plays every other algorithm, results logged and analyzed.

- Minimax with alpha-beta pruning, beam search, iterative deepening
- MCTS with standard, progressive history, and RAVE variants
- 15 head-to-head matchups benchmarked to completion
- Key finding: Iterative Deepening consistently outperforms all MCTS variants

[→ View repo](https://github.com/Hamsini11/chess-ai-arena)
...
|---|---|
| NVIDIA-Certified Associate — Generative AI (NCA-GENL) | NVIDIA |
| NVIDIA-Certified Professional — AI & ML (NCP-AAI) | NVIDIA |
...
**Frontend Engineer** — Accenture *(4 years)*
Enterprise-scale frontend development in Angular and TypeScript across client deployments.

---

## 🎓 Education

**MS, Information Science** — ML Concentration
...
*"The goal is not to build AI. The goal is to build AI that knows something worth knowing."*
